...
func Stat(args ...object.Object) object.Object {
	...
	fileMtime := &object.Integer{Value: int64(fileSys.(*syscall.Stat_t).Mtimespec.Sec)}
	...
	fileCtime := &object.Integer{Value: int64(fileSys.(*syscall.Stat_t).Ctimespec.Sec)}
	fileAtime := &object.Integer{Value: int64(fileSys.(*syscall.Stat_t).Atimespec.Sec)}
